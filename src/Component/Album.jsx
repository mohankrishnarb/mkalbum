...
export default function Album() {
    ...
    return (
        <React.Fragment>
            <header>
                <h1 className={`display-1 text-center py-5 ${style.albumH1}`}> <img src="https://cdn.onlinewebfonts.com/svg/img_296255.png" width={'100px'} alt="..." /> Mohan Krishna Album <img src="https://cdn.onlinewebfonts.com/svg/img_296255.png" width={'100px'} alt="..." /> </h1>
            </header>
